  ...
  return (
    ...
    <div className="three"  >
        <ul className="three__caption" >
            ...
            <img src="/src/components/img/tri-split.webp"   className="three__photo" alt="Aire Acondicionado Split uno" />
        </ul>
        <ul className="three__caption">
            <img src="/src/components/img/tri-splits.webp" className="three__photo" alt="Aire Acondicionado Split tres" />
         </ul>
        <ul className="three__caption">
             <img src="/src/components/img/tri-spli.webp" className="three__photo" alt="Aire Acondicionado Split cuatro" />
         </ul>
  </div>
  {/* ))} */}
