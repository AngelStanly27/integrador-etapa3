  ...
  return (
    ...
    <div className="three"  >
        <ul className="three__caption" >
            ...
            <img src="/src/components/img/deshumificador.webp"   className="three__photo" alt="Aire Acondicionado Split uno" />
        </ul>
        <ul className="three__caption">
            <img src="/src/components/img/deshumi-dos.webp" className="three__photo" alt="Aire Acondicionado Split tres" />
         </ul>
        <ul className="three__caption">
             <img src="/src/components/img/deshumi-tres.webp" className="three__photo" alt="Aire Acondicionado Split cuatro" />
         </ul>
  </div>
  {/* ))} */}
